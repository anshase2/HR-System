...
|---|---|
| Not required (`[AllowAnonymous]` or no `[Authorize]`) | Login, register applicant, set employee password, verify email, resend verification, list jobs, active jobs, get job by id, document extract, Gemini test |
